...
async def test_context_isolation():
    ...
    print(
        f"Context 1 after: test_var={ctx1.get(test_var)}, counter={ctx1.get(counter_var)}"
    )
    print(
        f"Context 2 after: test_var={ctx2.get(test_var)}, counter={ctx2.get(counter_var)}"
    )
    ...
    print(
        f"Context 3 after Python test: test_var={ctx3.get(test_var)}, counter={ctx3.get(counter_var)}"
    )
