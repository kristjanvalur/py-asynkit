...
class CoroStart:
    ...
    def is_new(self):
        """Convenience function to call `coro_is_new()` on the managed coroutine"""
        return coro_is_new(self.coro)

    def is_finished(self):
        """Convenience function to call `coro_is_finished()` on the managed coroutine"""
        return coro_is_finished(self.coro)
