...
async def test_first_send_assertion():
    ...
    try:
        ...
        print(f"C extension - ERROR: send('invalid') should have failed but got: {result}")
    except TypeError as e:
        print(f"C extension - send('invalid') correctly raised: {type(e).__name__}: {e}")
    except Exception as e:
        print(f"C extension - send('invalid') raised unexpected: {type(e).__name__}: {e}")
    ...
    try:
        ...
        print(f"Native coroutine - ERROR: send('invalid') should have failed but got: {result}")
    except TypeError as e:
        print(f"Native coroutine - send('invalid') correctly raised: {type(e).__name__}: {e}")
    except Exception as e:
